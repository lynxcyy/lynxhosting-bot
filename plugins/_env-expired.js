module.exports = {
  async all(m) {
    ...
    if (+new Date() > chats.expired) {
      ...
      chats.expired = 0
      this.sendContact(m.chat, [{ name: 'Owner', number: global.owner, about: 'Owner & Creator' }], m, { org: 'Contact Support', website: 'https://lynxbotapi.xyz', email: 'admin@lynxbotapi.xyz' })
