let handler = async (m, { conn, command }) => {
    ...
    if (new Date - user.lastbansos > 300000) {
      if (randomaku > randomkamu) {
        conn.sendFile(m.chat, 'https://telegra.ph/file/afcf9a7f4e713591080b5.jpg', 'korupsi.jpg', `Kamu Tertangkap Setelah Kamu korupsi dana bansos🕴️💰,  Dan Kamu harus membayar denda 3 Juta money💰`, m)
        user.money -= 3000000
        user.lastbansos = new Date * 1
      } else if (randomaku < randomkamu) {
        user.money += 3000000
        conn.sendFile(m.chat, 'https://telegra.ph/file/d31fcc46b09ce7bf236a7.jpg', 'korupsi.jpg', `Kamu berhasil  korupsi dana bansos🕴️💰,  Dan Kamu mendapatkan 3 Juta money💰`, m)
        user.lastbansos = new Date * 1
      } else {
