...
handler.all = async function (m) {
  ...
  if ((user.legendary * 1) > 1000000) {
    user.legendary = 1000000
  } else if ((user.legendary * 1) < 0) {
    user.legendary = 0
  }
  if ((user.mythic * 1) > 1000000) {
    user.mythic = 1000000
  } else if ((user.mythic * 1) < 0) {
    user.mythic = 0
  }
  if ((user.uncommon * 1) > 1000000) {
    user.uncommon = 1000000
  } else if ((user.uncommon * 1) < 0) {
    user.uncommon = 0
  }
  if ((user.common * 1) > 1000000) {
    user.common = 1000000
  ...
  if ((user.potion * 1) > 1000000) {
    user.potion = 1000000
  } else if ((user.potion * 1) < 0) {
    user.potion = 0
  }
  if ((user.berlian * 1) > 1000000) {
    user.berlian = 1000000
  } else if ((user.berlian * 1) < 0) {
    user.berlian = 0
  }
  if ((user.emas * 1) > 1000000) {
    user.emas = 1000000
  } else if ((user.emas * 1) < 0) {
    user.emas = 0
  }
  if ((user.diamond * 1) > 1000000) {
    user.diamond = 1000000
