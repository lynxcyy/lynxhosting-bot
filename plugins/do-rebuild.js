...
let handler = async (m, { isOwner, conn }) => {
    ...
    try {
        ...
        let sections = [{
            title: 'Pilih Droplet Yang Akan Di Rebuild',
        ...
        await conn.sendAIMessage(m.chat, messageSections, m, {
            ...
            content: 'Silakan pilih droplet yang ingin Anda Rebuild.',
            footer: wm
        });
    } catch (error) {
...
handler.tags = 'vps'
handler.help = 'rebuilddroplet'
handler.command = /^(rebuild|ganti)dro(p|plet)|rebuild$/i;
