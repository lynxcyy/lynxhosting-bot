...
title: `© Lynx MD`,
thumbnailUrl: 'https://telegra.ph/file/eb417f1f5bc13ea0d2fe7.jpg',
mediaType: 1,
renderLargerThumbnail: true 
      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          m.reply(`Kamu Belum Terdaftar Di Database!\nKetik .daftar nama.umur untuk mendaftar`)
        return
          }
          ...
          if (!isPrems && plugin.limit && db.data.users[m.sender].limit < plugin.limit * 1) {
            m.reply("Limit Kamu Telah Habis!\nGunakan .buy limit (jumlah) untuk membeli limit")
            continue
          }
